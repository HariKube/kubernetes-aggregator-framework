...
func NewServer(config ServerConfig) *Server {
	...
	for i := range config.APIKinds {
		...
		if ak.Resource != nil && ak.CustomResource != nil {
			panic("APIKind cannot have both Resource and CustomResource defined: " + ak.ApiResource.Name)
		}
